...
#define HOMING_CYCLE_0 (1<<Z_AXIS)  // Home Z first to clear, then pull-off on Z.
#define HOMING_CYCLE_1 (1<<X_AXIS)  // Then home X (CoreXY), pull-off purely on X.
#define HOMING_CYCLE_2 (1<<Y_AXIS)  // Then home Y (CoreXY), pull-off purely on Y.
...
// Disable the stepper enable pin if drivers are hard-enabled.
#define DISABLE_STEPPER_ENABLE_PIN

// Enables software limit switch debounce.
