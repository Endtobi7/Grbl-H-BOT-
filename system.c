...
// These let the homing cycle recover a pure single-axis position from the A/B motor
// step counts, so that a single-axis pull-off does not bleed into the other axis.
#ifdef COREXY
